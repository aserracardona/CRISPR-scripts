...
This script requieres [Biopython](https://biopython.org/) and [pandas](https://pandas.pydata.org/) installed and only works for *S. cerevisiae* genes. However, it is not complicated to change the input sequence for any other gene. 
